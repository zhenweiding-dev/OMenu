...
User Preferences: {"keywords":["healthy","quick"],"preferredItems":["chicken","rice"],"dislikedItems":["mushrooms"],"numPeople":2,"budget":120,"difficulty":"medium","cookSchedule":{"monday":["dinner"],"tuesday":["lunch"],"wednesday":["lunch","dinner"],"thursday":[],"friday":["dinner"],"saturday":["breakfast","lunch"],"sunday":[]}}
```
